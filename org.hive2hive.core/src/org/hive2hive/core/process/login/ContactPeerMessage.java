...
public class ContactPeerMessage extends BaseDirectMessage implements IRequestMessage {
	...
	public ContactPeerMessage(PeerAddress targetPeerAddress, PeerAddress senderAddress, String evidenceContent) {
		super(targetPeerAddress, senderAddress);
	...
	public void run() {
		...
		ResponseMessage response = new ResponseMessage(messageID, targetPeerAddress, senderAddress, evidenceContent);
