...
public class ModifyNotifyMessageFactory implements INotificationMessageFactory {
	 ...
	 */
	public ModifyNotifyMessageFactory(PublicKey fileKey) {
		this.fileKey = fileKey;
	}

	@Override
	public BaseDirectMessage createNotificationMessage(PeerAddress receiver, String userId) {
		return new FileNotificationMessage(receiver, FileOperation.MODIFIED, fileKey);
	}
}
