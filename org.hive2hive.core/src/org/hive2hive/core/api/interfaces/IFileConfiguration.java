...
public interface IFileConfiguration {
	 ...
	 * developer does not want the version feature, just set this value to 1.
	 ...
	 * few peers to work very hard. We recommend to adapt the chunk size to the network performance.
