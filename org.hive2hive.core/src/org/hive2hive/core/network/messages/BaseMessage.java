...
public abstract class BaseMessage implements Runnable, Serializable {
	 ...
	 * asynchronous message with the default sending behavior
	...
	/**
	 * This method is called on the receiver node (the one responsible for
	 * {@link #targetKey}) of this message. It is used to check if the target
	 ...
	 * see
	 * {@link MessageReplyHandler#reply(net.tomp2p.peers.PeerAddress, Object)}
	 * and
	 ...
	 * method and adhere to the following points:</br> <li>This method must
	 * terminate as quickly as possible.</li> <li>No blocking in any way is
	 * allowed.</li> <li>No sending of messages or other network activities are
	 * permitted.</li>
	 * 
